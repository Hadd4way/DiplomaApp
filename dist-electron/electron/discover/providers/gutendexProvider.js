...
exports.gutendexProvider = void 0;
const GUTENDEX_BASE_URL = 'https://gutendex.com/books';
function isUsableDownloadUrl(downloadUrl) {
...
exports.gutendexProvider = {
    async search(query, options = {}) {
        ...
        return (payload.results ?? []).map(mapBook).filter((book) => Boolean(book));
    }
};
