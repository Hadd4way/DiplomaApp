...
const flow_progress_1 = require("./flow-progress");
...
electron_1.app.whenReady().then(() => {
    ...
    electron_1.ipcMain.handle(ipc_1.IPC_CHANNELS.wishlistList, () => (0, wishlist_1.listWishlistItems)(db, libraryId));
    electron_1.ipcMain.handle(ipc_1.IPC_CHANNELS.wishlistSave, (_event, payload) => (0, wishlist_1.saveWishlistItem)(db, libraryId, payload));
    electron_1.ipcMain.handle(ipc_1.IPC_CHANNELS.wishlistRemove, (_event, payload) => (0, wishlist_1.removeWishlistItem)(db, libraryId, payload));
    electron_1.ipcMain.handle(ipc_1.IPC_CHANNELS.wishlistUpdate, (_event, payload) => (0, wishlist_1.updateWishlistItem)(db, libraryId, payload));
    ...
    electron_1.ipcMain.handle(ipc_1.IPC_CHANNELS.epubHighlightsList, (_event, payload) => (0, highlights_1.listEpubHighlights)(db, progressDb, libraryId, payload));
    electron_1.ipcMain.handle(ipc_1.IPC_CHANNELS.epubHighlightsCreate, (_event, payload) => (0, highlights_1.createEpubHighlight)(db, progressDb, libraryId, payload));
    ...
    electron_1.ipcMain.handle(ipc_1.IPC_CHANNELS.flowProgressGet, (_event, payload) => (0, flow_progress_1.getFlowProgress)(db, progressDb, libraryId, payload));
    electron_1.ipcMain.handle(ipc_1.IPC_CHANNELS.flowProgressSet, (_event, payload) => (0, flow_progress_1.setFlowProgress)(db, progressDb, libraryId, payload));
